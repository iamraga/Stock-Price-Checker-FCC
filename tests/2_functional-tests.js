    ...
    suite("GET /api/stock-prices => stockData object", () => {
      ...
      test("1 stock", (done) => {
       chai.request(server)
        ...
        .end((err, res) => {
          ...
          assert.isNumber(res.body.stockData.price, "the price must be a number");
          assert.isNumber(res.body.stockData.likes, "the likes must be a number"); 
          done();
        });
      });
      ...
      test("1 stock with like", (done) => {
       chai.request(server)
        ...
        .end((err, res) => {
          ...
          assert.isNumber(res.body.stockData.likes, "the likes must be a number"); 
          assert.isNumber(res.body.stockData.likes, "the likes must be a number"); 
          assert.notEqual(res.body.stockData.likes, 0, "the likes must be a number"); 
          done();
        });
      });
      ...
      test("2 stocks", (done) => {
        ...
        .end((err, res) => { 
          ...
          assert.isNumber(res.body.stockData[0].price, "the price must be a number");
          assert.isNumber(res.body.stockData[0].rel_likes, "the rel_likes must be a number"); 
          assert.isNumber(res.body.stockData[1].price, "the price must be a number");
          assert.isNumber(res.body.stockData[1].rel_likes, "the rel_likes must be a number");
          assert.equal(res.body.stockData[0].rel_likes, -1*res.body.stockData[1].rel_likes); 
          done();
        });
      });
